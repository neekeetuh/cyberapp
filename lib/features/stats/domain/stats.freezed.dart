...
class _$StatsImpl implements _Stats {
  ...
  @override
  String toString() {
    return 'Stats(playerName: $playerName, teamTag: $teamTag, rating: $rating, acs: $acs, kd: $kd, kast: $kast, adpr: $adpr, kpr: $kpr, apr: $apr, fkpr: $fkpr, fdpr: $fdpr, hs: $hs, csp: $csp)';
  }
...
abstract class _Stats implements Stats {
  const factory _Stats(
      ...
      @JsonKey(name: 'clutch_success_percentage')
      required final String csp}) = _$StatsImpl;
